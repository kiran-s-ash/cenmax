        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-5 align-items-center">
          <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start order-2 order-lg-0" data-cues="slideInDown" data-group="page-title" data-delay="600">
            ...
            <div class="d-flex justify-content-center justify-content-lg-start" data-cues="slideInDown" data-group="page-title-buttons" data-delay="900">
              <span><a href="demo_form.php" class="btn btn-primary rounded me-2">Add Employe</a></span>
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered">
                          ...
                          <tbody>
                              ...
                              $sql = "SELECT first_name, last_name, email, branch_id, mobile_number FROM employees_1";
                              ...
                              if ($result->num_rows > 0) {
                                  while($row = $result->fetch_assoc()) {
                                      ...
                                      echo "<td><button class='btn btn-primary viewBtn' data-toggle='modal' data-target='#viewModal' data-firstname='".$row["first_name"]."' data-lastname='".$row["last_name"]."' data-email='".$row["email"]."' data-branchid='".$row["branch_id"]."' data-mobilenumber='".$row["mobile_number"]."'>View</button></td>";
                                      echo "</tr>";
                                  }
                              } else {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel">View Employee Details</h5>
  ...
  <script>
        $(document).ready(function() {
            $('.viewBtn').click(function() {
                ...
                var modalContent = "<p><strong>First Name:</strong> " + firstName + "</p>";
                modalContent += "<p><strong>Last Name:</strong> " + lastName + "</p>";
                modalContent += "<p><strong>Email:</strong> " + email + "</p>";
                modalContent += "<p><strong>Branch ID:</strong> " + branchId + "</p>";
                modalContent += "<p><strong>Mobile Number:</strong> " + mobileNumber + "</p>";
